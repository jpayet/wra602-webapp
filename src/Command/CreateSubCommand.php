    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $l_subscriptions = [
            [
                ...
                'price' => 0,
                'pdf_limit' => 10,
                'description' => 'Abonnement gratuit qui permet de générer 10 PDFs par jour',
                'media' => '',
            ],
            [
                'title' => 'Raptor Junior',
                'price' => 9.99,
                'pdf_limit' => 25,
                'description' => 'Abonnement plus avancée qui octroie la génération de 25 PDFs par jour',
                'media' => '',
            ],
            [
                'title' => 'Giant Raptor',
                'price' => 19.99,
                'pdf_limit' => 100,
                'description' => 'Abonnement premium qui permet de générer 100 PDFs par jour',
                'media' => '',
            ],
        ];
